...
### [Set Conversation Score](/api-ref/capture-feedback/set-conversation-score)
...
### [Set Messages Score](/api-ref/capture-feedback/set-messages-score)
...
### [Set Prompt Run Score](/api-ref/capture-feedback/set-prompt-run-score)
