...
### [Run Prompt (Non-streaming)](/api-reference/prompts/run-prompt-non-streaming)
...
### [Run Prompt (HTTP/2 Streaming)](/api-reference/prompts/run-prompt-http2-streaming)
...
### [Run Prompt (SSE Streaming)](/api-reference/prompts/run-prompt-sse-streaming)
